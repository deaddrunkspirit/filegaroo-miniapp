...
const AddFolder: React.FC<AddFolderProps> = ({ parent_content_id }) => {
    ...
    return (
        <div className="relative flex flex-col items-center justify-center py-[7.75vw] px-[8.9vw] w-[39vw] h-[31vw] rounded-3xl shadow-md shadow-gray-300 dark:shadow-black
