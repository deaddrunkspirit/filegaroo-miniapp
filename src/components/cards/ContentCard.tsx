...
const ContentCard: React.FC<ContentCardProps> = ({ content }) => {
    ...
    return (
        ...
        <div onClick={content.type === 2 ? handleFolderClick : handleMessageClick} 
                className='relative z-20 flex flex-col gap-[2vw] items-center justify-center w-[39vw] h-[31.5vw] px-[3.8vw] pb-[2.56vw] pt-[5.475vw] rounded-3xl dark:drop-shadow-xl bg-light-secondary text-light-onsecondary  dark:bg-dark-secondary dark:text-dark-onsecondary m-0 shadow-lg shadow-gray-400 dark:shadow-black' 
            >
            ...
            <p className='flex grow break-all h-[8vw] text-sm line-clamp-2 text-ellipsis overflow-hidden ...'>
                {content.title}
            </p>
