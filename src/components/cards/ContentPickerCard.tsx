...
const ContentPickerCard: React.FC<ContentPickerCardProps> = ({ content, isSelected, updateSelectedCards }) => {
    ...
    return (
        <>
            <div onClick={onCheckedChange} className='relative z-20 flex flex-col gap-[2vw] items-center text-center justify-start w-[39vw] h-[32vw] px-[3.8vw] pb-[2.56vw] pt-[5.475vw] rounded-3xl dark:drop-shadow-xl bg-light-secondary text-light-onsecondary  dark:bg-dark-secondary dark:text-dark-onsecondary m-0 shadow-lg shadow-gray-400 dark:shadow-black'>
