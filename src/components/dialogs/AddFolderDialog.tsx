    ...
    return (
        <div className="z-[1000] relative m-0 flex-col items-center justify-center w-[55vw] h-[30vw] p-[4vw] ml-[25vw] space-y-[2vw] rounded-3xl bg-color_input dark:bg-dark-secondary bg-opacity-80 dark:bg-opacity-80">
            <div className=" relative h-11 w-full">
                <input placeholder={getLocalizationString(lang!, 'folder-name-placeholder')} value={name} onChange={(e) => setName(e.target.value)} 
                ...
                <label className="after:content[''] 
                                ...
                                peer-focus:after:border-light-500 dark:peer-focus:after:border-dark-primary">{getLocalizationString(lang!, 'name')}</label>
            </div>
