...
const SelectContentsDialog: React.FC<SelectContentsDialogProps> = ({ currFolderName, content, onClose }) => {
    ...
    return <div className="absolute flex flex-col items-center justify-start ml-[-8.25vw] mt-[-18.5vw] w-dvw h-full z-[1000] top-0 left-0 bg-light-primary dark:bg-dark-primary origin-center">
