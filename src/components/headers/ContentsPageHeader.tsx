...
const ContentsPageHeader: React.FC<ContentsPageHeaderProps> = ({title }) => {
  ...
  return (
    <div className="flex flex-row justify-center items-center pt-[3.61vw] pb-[2.9vw] px-[8vw] h-[18.5vw] gap-[5.56vw]">
      ...
      <h1 className={`flex text-lg w-[59.72vw] h-[12vw] text-light-onprimary dark:text-dark-onprimary break-all leading-[6vw] line-clamp-2 text-ellipsis overflow-hidden ...'`}>
        {title}</h1>
    </div>
  );
}
